...
public class StartTaffy {
	...
	private static void IsWorkNow(Person p1, int i) {
	...
	private static int IsCusEnter(MakeQueue<Person> Person, int TotCusNum, int i) {
	...
	private static void PrintTot(MakeQueue<Person> Result) {
		Person p1;
		int ResSize;
		ResSize = Result.size();
