...
public class WorkProcess {
	public static void Work(MakeQueue<Person> Person, MakeQueue<Person> Result, Person p1, int TotWaitTime,
		...
		int TotWaitPerson = Person.size() + 1;
		...
		System.out.printf("--------------------480분 업무 종료---------------------\n\n고객별 평균 대기시간은 %d분이며 처리 못한 인원은 %d명입니다.\n\n",
